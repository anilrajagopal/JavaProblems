...
public class LearnListAll {
	...
	public static void main(String[] args) {
		...
		System.out.println("The item at index 2 is : "+mentors.get(2));
		// remove item from an particular index
		String removedData = mentors.remove(2);
		System.out.println(" Removed Data : "+removedData);
		
		// dispally items after removal
